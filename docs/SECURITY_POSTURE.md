...
| **Adversarial suite** | Known bypass classes as regressions | Purpose-built pytest suite (`-m security`) | ✅ 259 tests | `make test-security` |
...
(259 tests, `pytest -m security`) encoding specific known bypass classes:
