...
| **Adversarial suite** | Known bypass classes as regressions | Purpose-built pytest suite (`-m security`) | ✅ ~191 tests | `make test-security` |
...
(~191 tests, `pytest -m security`) encoding specific known bypass classes:
...
[docs/THREAT_MODEL.md](THREAT_MODEL.md) enumerates 31 threats (QG-01…QG-31),
