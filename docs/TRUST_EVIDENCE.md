...
| **Adversarial suite** | Known bypass classes as regressions | Purpose-built pytest suite (`-m security`) | ✅ 731 tests | `make test-security` |
...
(731 tests, `pytest -m security`) encoding specific known bypass classes:
