...
| **Adversarial suite** | Known bypass classes as regressions | Purpose-built pytest suite (`-m security`) | ✅ 673 tests | `make test-security` |
...
(673 tests, `pytest -m security`) encoding specific known bypass classes:
