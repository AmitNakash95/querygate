...
| **Adversarial suite** | Known bypass classes as regressions | Purpose-built pytest suite (`-m security`) | ✅ 721 tests | `make test-security` |
...
(721 tests, `pytest -m security`) encoding specific known bypass classes:
