...
| 161 | `/admin/reload-config`'s generic exception handler can leak a live credential in its HTTP 400 body | S | — |
...
### 161. `/admin/reload-config`'s generic exception handler can leak a live credential in its HTTP 400 body
