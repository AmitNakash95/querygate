...
| 168 | Cross-connection joins are reflected as if both connections are always on the same physical server instance, with nothing that actually checks it | S–M | — |
...
### 168. Cross-connection joins are reflected as if both connections are always on the same physical server instance, with nothing that actually checks it
