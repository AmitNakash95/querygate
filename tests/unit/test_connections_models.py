...
_VALID_PAIRS = [
    ...
    (DatabaseDialect.BIGQUERY, "bigquery://my-project/my_dataset"),
]
...
_MISMATCHED_PAIRS = [
    ...
    (DatabaseDialect.BIGQUERY, "postgresql+asyncpg://user:pass@host:5432/db", "postgresql"),
    (DatabaseDialect.POSTGRESQL, "bigquery://my-project/my_dataset", "bigquery"),
]
