...
Every test gets an isolated in-memory connection registry and policy store
(a "demo" connection with a permissive default policy) so tests never
depend on load order, real config files, or leak state between each other.
"""
