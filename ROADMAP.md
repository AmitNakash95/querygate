...
- [ ] **193** — `docs/product-guide.html` has no freshness gate against its
  ...
  by exactly the two Decision Log entries the merge added (regenerated by hand
  in that pass). Filed here rather than in Phase 3 because it is derived-artifact
