...
whole overview, including the per-connection breakdown. The browser dashboard
that charts this, a config/catalog-change trend card (those events live in the
